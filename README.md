...
После запуска полного стека откройте <http://localhost> (<https://statistics-helper.ru/> сайт развернут на данном домене) и войдите под демонстрационным администратором:
...
Для демонстрации используйте 2026 год:
